...
<div class="loginregistercont">
	...
	<h4><?php echo JText::_('VRMSGINSTRUCCIONES'); ?></h4>
	...
	<table>
	<tr><td align="right">&nbsp;</td><td><input type="button" value="<?php echo JText::_('VRBTONCLIENTECORP'); ?>" class="booknow" id="ClienteE" onclick="myFunction1()" /></td></tr>
	<tr><td align="right">&nbsp;</td><td><input type="button" value="<?php echo JText::_('VRBTONNATURAL'); ?>" class="booknow" id="Persona" onclick="myFunction2()"/></td></tr>
	</table>
