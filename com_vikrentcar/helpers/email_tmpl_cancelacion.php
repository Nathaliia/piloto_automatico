...
<?php echo JText::_('VRLIBNINE'); ?>:</h3>
     ...
     <div class="pilotodetail" style="width: 95.8%; clear: both; float: none; border-radius: 4px; -moz-border-radius: 4px; -webkit-border-radius: 4px; line-height: 1.6em; padding: 10px; border: 1px solid #eee;">
        ...
        <p> <strong><?php echo JText::_('VRLIBNINEPILOTNAME'); ?>: {name_Cond} </strong></p>

        <p> <strong><?php echo JText::_('VRLIBNINECELUCOND'); ?>: {CelularCond}</strong></p>

        <p> <strong><?php echo JText::_('VRLIBNINEDOCUMENTO'); ?>: {CedulaCond}</strong></p>
    ...
    <div class="canceldetail" style="width: 95.8%; clear: both; float: none; border-radius: 4px; -moz-border-radius: 4px; background: #fbfbfb; -webkit-border-radius: 4px; line-height: 1.6em; padding: 10px; border: 1px solid #eee;">
        <h3 class="Stile1" style="font-size: 18px; font-weight: bold; margin: 0 0 10px; padding: 0;">
       
       <?php echo JText::_('VRLIBNINECANCEL'); ?>:</h3>
        <div style="font-size:14px;" >
        
        <p><?php echo JText::_('VRLIBNINQUIENCANCELO'); ?>: {quienCancelo}</p>

        <p><?php echo JText::_('VRLIBNINMOTIVOCANCELACION'); ?>: {motivosCancel}</p>
        </div>
...
<span class="Stile10" style="font-size: 18px; font-weight: bold;"><?php echo JText :: _('VRLIBSIX'); ?></span><div align="right" style="font-size: 14px; float: right;"><strong>{order_total}</strong></div>
        ...
        <strong><?php echo JText :: _('VRLIBTENTHREE'); ?>:</strong><br>
         <a href="{infopersonal}">{infopersonal}</a>
        </span><br></p>
