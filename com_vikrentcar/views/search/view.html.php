				...
				if (vikrentcar :: dateIsValid($ppickupdate) && vikrentcar :: dateIsValid($preleasedate)) {
					...
					if ($second > $first && $first > $actnow) {
						...
						if (!empty ($pattr)){
							...
							$q = "SELECT * FROM `#__vikrentcar_dispcost` WHERE `days`='" . $daysdiff . "' AND `attrdata`='' ORDER BY `#__vikrentcar_dispcost`.`cost` ASC, `#__vikrentcar_dispcost`.`idcar` ASC;";
						}
						$dbo->setQuery($q);
						$dbo->Query($q);
						if ($dbo->getNumRows() > 0) {
							...
							if($checkhourly) {
								/*
								if(vikrentcar:: isPaquete()==0){
									
								
									//aqui va deteccion de cantidad paquetes	
										$paqueteHoras= vikrentcar :: verPaqueteUser();
										
										if($paqueteHoras>$hoursdiff){
											$hoursdiff=1;
										}else{
											$hoursdiff=$hoursdiff-$paqueteHoras;
										}
								
								}
								*/
								
							    //$dat =vikrentcar ::sayCostWithCredito(1,2,12);
								//aqui trae los costos de la tabla de precios por hora
							...
							foreach ($arrtar as $kk => $tt) {
								...
								if (intval($car[0]['avail']) == 0) {
									...
									if($flagPaq!='Credito'){
										//aqui restriccion pico y placa
										$arrtar= vikrentcar::evalRegEx($pplace,$car,$arrtar,$kk);
									}else{
									 //nothing
									}
								...
								if(!empty($pcardetail) && array_key_exists($pcardetail, $arrtar)) {
                                    ...
                                    if (@ count($arrtar) == 1 ) {  
                                        foreach ($arrtar as $k => $r) {
                                            $returnplace = JRequest :: getInt('returnplace', '', 'request');
                                            eval(read(''));
                                            $mainframe->redirect("index.php?option=com_vikrentcar&task=showprc&caropt=" . $k . "&days=" . $daysdiff . "&pickup=" . $first . "&release=" . $second . "&place=" . $pplace . "&pattr=" . $pattr . "&city_ini=" . $city_ini . "&add_ini=" . $add_ini . "&city_fin=" . $city_fin . "&add_fin=" . $add_fin . "&returnplace=" . $returnplace . (!empty ($pitemid) ? "&Itemid=" . $pitemid : ""));
                                            return;
                                        }
                                    }
